...
class MatchSpider(scrapy.Spider):
    ...
    def parseSpielinfo(self, response):
        ...
        m['matchday'] = extract_with_css('div.kick__v100-scoreboardInfo::text')
        ...
        m['attendance'] = extract_with_css('.kick__gameinfo__item--game-preview .kick__tabular-nums p::text')
